...
var treeModule = angular.module('dpdx.tree',['ngMaterial','ngAnimate']);

treeModule.directive('dpdxTree',['$compile','$rootScope',function($compile,$rootScope){
  return {
    restrict: 'E',
    replace: 'true',
    scope: {
...
treeModule.directive('node',['$compile','$rootScope',function($compile,$rootScope){
  return {
    ...
    templateUrl: 'webapp/app/common/tree/partials/tree.html' ,
    link: function(scope,elem,attrs){
