...
var datatable = angular.module('angular.datatable',['ngMaterial','ngAnimate']);

datatable.directive('angularDatatable',['$compile',function($compile){
    return {
        restrict: 'E',
        replace: true,
        scope: {
        ...
        templateUrl: 'datatable/partials/datatable.html',
